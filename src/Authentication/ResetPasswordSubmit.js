            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className=' w-80'>
                    <input
                        ...
                        className="mt-1 block w-full px-3 py-2 bg-white border border-orange-500 rounded-md text-sm shadow-sm placeholder-slate-400 focus:outline-none
                    ...
                    <div className=' text-end grid gap-2 grid-cols-2'>
                        <button
                            type='submit'
                            className=' border-2 mt-4 border-orange-500 rounded-lg py-2 bg-orange-500 text-slate-50 text-xs font-bold hover:duration-500 duration-100 focus:bg-orange-500   px-1 md:px-6 w-full'>Submit</button>
                        <Link to="/">
                            <button
                                type='button'
                                onClick={() => setShowLoginModal(false)}
                                className=' border-2 mt-4  border-orange-500 rounded-lg  bg-red-500 text-slate-50 text-xs font-bold hover:duration-500 duration-100 focus:bg-red-600 py-2  px-1 md:px-6 w-full'>Cancel</button>
                        </Link>
                    </div>
                </div>
