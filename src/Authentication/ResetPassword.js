            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <div >
                    ...
                    <div className=' text-end grid gap-2 grid-cols-2'>
                        <button
                            type='submit'
                            className=' border-2 border-orange-500 hover:text-white mt-4 py-2 text-base  hover:bg-orange-500 text-black p-0 rounded-lg    font-bold hover:duration-500 duration-100   px-1 md:px-6 w-full'>Reset Password</button>
                        <button
                            type='button'
