            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className=''>
                    ...
                    <div className=' text-end grid gap-2 grid-cols-2'>
                        <button
                            type='submit'
                            className=' border-2 mt-4 border-amber-500 rounded-lg  bg-amber-500 text-slate-50 text-xs font-bold hover:duration-500 duration-100 focus:bg-amber-500  py-1 px-1 md:px-6 w-full'>Reset Password</button>
                        <button
                            type='button'
                            onClick={() => setIsResetPass(false)}
                            className=' border-2 mt-4 border-amber-500 rounded-lg  bg-red-500 text-slate-50 text-xs font-bold hover:duration-500 duration-100 focus:bg-red-600  py-1 px-1 md:px-6 w-full'>Cancel</button>
                    </div>
                </div>
