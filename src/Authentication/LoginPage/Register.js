            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className=''>
                    ...
                    <div className=' text-end'>
                        <button type='submit' className=' bg-gradient-to-tr from-amber-500 to-pink-600 p-0 border-2 mt-4 border-amber-500 rounded-lg  text-slate-50 text-xs font-bold hover:duration-500 duration-100 focus:bg-gradient-to-tl  py-1 px-1 md:px-6 w-full'>Register</button>
                    </div>
                </div>
            </form>
        </div>
