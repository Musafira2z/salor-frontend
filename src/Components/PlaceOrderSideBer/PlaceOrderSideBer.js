            ...
            <div >
                <div className=' p-2 flex justify-between '>
                    <div className='flex  items-center '>
                        <img src="/favicon.ico" alt="musafir Logo" loading="lazy" className='h-5' /><h4 className=' ml-2 font-bold'>  {checkoutData?.lines.length || "00"} Items</h4>
                    </div>
                </div>
                ...
                <div >
                    ...
                    <div className='flex justify-center'>
                        <button
                            ...
                            className=' w-52   py-1 text-sm text-center rounded text-slate-50 hover:text-slate-50 active:text-slate-50 focus:text-slate-50    bg-orange-500  border border-orange-500'>Place order
                        </button>
                    </div>
                </div>
            </div>
