...

            {
                ...
                <div className='col-span-10 grid grid-cols-6 '>
                    <input
                        ...
                        className=" col-span-4 mt-1 block px-3 w-full bg-white  border border-orange-500 rounded-md text-base shadow-sm placeholder-slate-400 focus:outline-none focus:border-orange-500 focus:ring-2 focus:ring-orange-500 disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 invalid:green-pink-500 invalid:text-pink-600 focus:invalid:border-orange-500 focus:invalid:ring-orange-500 rounded-r-none"
                    />
                    <button
                        onClick={setPromoCodeHandler}
                        className='col-span-2  mt-1 block px-1 bg-orange-500 text-white border border-orange-500 rounded-md text-base shadow-sm placeholder-slate-400 focus:outline-none focus:border-orange-500 focus:ring-2 focus:ring-orange-500 disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 invalid:green-pink-500 invalid:text-pink-600 focus:invalid:border-orange-500 focus:invalid:ring-orange-500 rounded-l-none'>Apply</button>
                </div>}
