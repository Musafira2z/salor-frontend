                                        ...
                                        <div className='grid lg:grid-cols-2 gap-3  mb-5 md:mx-0 mx-3'>
                                            ...
                                            <Modal
                                                ...
                                                modalOpenButton={
                                                    <button
                                                        ...
                                                        className='text-white bg-orange-500     font-bold   text-base px-6 py-2  rounded w-full '
                                            ...
                                            <div className='flex   w-full   '>
                                                <input
                                                    ...
                                                    className=" placeholder:text-slate-400  placeholder:text-base block bg-white w-full border border-slate-300 rounded-md rounded-r-none py-2 px-2  shadow-sm focus:outline-none focus:border-orange-500  focus:ring-orange-500  focus:ring-1 text-base "
                                                    placeholder="Search your address"
                                                    type="text"
                                                    name="search" />

                                                <button
                                                    className=' bg-orange-500  flex gap-1 justify-center items-center  w-16 text-slate-50 rounded-lg rounded-l-none text-base font-bold'>
                                                    <BiSearch size={17} />
                                                </button>
                                            </div>
                                        </div>
