    ...
    return (
        ...
        <div className=" " >
            <div className="flex flex-col items-center" >
                <h1 className=' text-center py-2  w-full text-xl font-bold bg-green-500 text-slate-50 my-2' > F.A.Q</h1 >
            </div >
            <div className="grid divide-y divide-neutral-200 w-full mx-auto mt-8" >
                ...
                <div className="" >
                    <details className="group" >
                        <summary className="flex justify-between items-center py-5 font-medium cursor-pointer list-none" >
